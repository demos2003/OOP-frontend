        ...
        <div className="holder_nav">
          <div>
            <p className="options">
              ...
              <a onClick={() => setActive("Pending1")}>Pending</a>
            </p>
            <p className="options">
              <AiOutlineCheckCircle className="nav_icon" />
              <a onClick={() => setActive("Approved1")}>Approved</a>
            </p>
            <p className="options">
              <MdOutlineCancel className="nav_icon" />
              <a onClick={() => setActive("Denied1")}>Denied</a>{" "}
            </p>
            <p className="options">
              <RiCheckDoubleLine className="nav_icon" />
              <a onClick={() => setActive("Double1")}>Double Booked</a>{" "}
            </p>
          </div>
        </div>
        <hr></hr>
